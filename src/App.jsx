...
//   onClick={() => window.open("https://wa.me/2348089811603", "_blank")}
// >
...
// Name of the Firestore collection where reviews are stored
const REVIEWS_COLLECTION = 'itagokwaife_reviews';
...
const menuItems = [
  {
    id: 1,
    title: "itago Signature Grilled Fish",
    desc: "Fresh whole fish grilled over charcoal and served with our tasty pepper sauce for a rich smoky flavor.",
    img: "fishthree.jpeg"
  },
  {
    id: 2,
    title: "itago Peppered Fish Special",
    desc: "Soft, spicy fish cooked in our rich pepper sauce and served with sweet ripe plantains.",
    img: "grilled-fish.png"
  },
  {
    id: 3,
    title: "itago Flame-Grilled Chicken",
    desc: "Juicy chicken marinated with our special spices and grilled over charcoal until perfectly tender.",
    img: "Flame-Marinated-Chickens.jpg"
  },
  {
    id: 4,
    title: "itago Smoky Turkey",
    desc: "Well-seasoned turkey grilled to perfection with a smoky flavor that's delicious in every bite.",
    img: "Smoky-Local-Turkey.jpeg"
  },
  {
    id: 5,
    title: "itago Mixed Grill Feast",
    desc: "A tasty combination of grilled meats served with crispy fries and our signature pepper sauce.",
    img: "Signature-Barbecue-Pack.avif"
  },
  {
    id: 6,
    title: "itago Loaded Shawarma",
    desc: "Soft shawarma filled with juicy meat, sausage, fresh vegetables, and our creamy homemade sauce.",
    img: "itago-sharwa.png"
  }
];

// Default seed reviews shown before any visitor adds their own
// These are static fallback reviews and are NOT stored in Firebase.
const defaultReviews = [
  { id: 'seed-1', name: "Tunde A.", text: "The grilled fish is absolutely amazing. Authentic smoky execution right in the heart of Lagos.", rating: 5 },
  { id: 'seed-2', name: "Amaka O.", text: "Consistently fiery, incredibly fresh, and deeply satisfying. My standard daily order location.", rating: 5 },
  { id: 'seed-3', name: "Kelechi N.", text: "The loaded shawarma layout is pure madness. Massive filling allocation and super clean flavors.", rating: 5 },
  { id: 'seed-4', name: "Bisi M.", text: "Fast processing times coupled with high-tier packaging standards. Highly recommended!", rating: 5 }
];
...
>
  ...
  <div className="feature-card">
    ...
    <h3>Freshly Grilled Every Time</h3>
    <p>
      Every meal is grilled fresh when you order, giving you that rich smoky
      taste and hot, delicious food every time.
    </p>
  </div>
  ...
  <div className="feature-card">
    ...
    <p>
      We keep our cooking environment clean and organized, so every meal is
      prepared with care, freshness, and high hygiene standards.
    </p>
  </div>
  ...
  <div className="feature-card">
    ...
    <h3>Fast Delivery</h3>
    <p>
      We prepare your order as quickly as possible and ensure it gets to you
      hot, fresh, and ready to enjoy.
    </p>
  </div>
  ...
  <div className="feature-card">
    ...
    <p>
      We're always happy to welcome you. Whether you're ordering for the first
      time or you're a regular customer, we treat everyone like family.
    </p>
  </div>
</div>
      </section>
 ...
 * ReviewsSection
 * Displays the seed reviews plus any reviews visitors have submitted.
 * Visitor-submitted reviews are now stored in Firebase Firestore, so
 * they are public and visible to EVERY visitor of the site in real time.
 */
function ReviewsSection({ defaultReviews }) {
  ...
  // Subscribe to the reviews collection in real time.
  // Any visitor who submits a review will instantly show up for everyone.
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (err) => {
        console.error('Could not load reviews from Firebase:', err);
        setLoadError(true);
        setLoadingReviews(false);
      }
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Could not save review to Firebase:', err);
      setErrors({ submit: 'Something went wrong sending your review. Please try again.' });
    } finally {
      setSubmitting(false);
    }
  };

  // Cloud reviews (newest first) followed by the static seed reviews
  const allReviews = [...cloudReviews, ...defaultReviews];
  ...
  return (
    <section className="reviews-section" id="reviews">
      ...
      {loadingReviews && (
        <p className="section-subtitle-center">Loading reviews...</p>
      )}

      {loadError && (
        <p className="section-subtitle-center">
          Couldn't load the latest reviews right now, showing our featured reviews below.
        </p>
      )}
